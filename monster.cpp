...
monster::monster()
{
    ...
    first.store_pic("F:\\qt\\test_rpg\\test_vision1\\pic\\skill_ball.png");
...
void monster::loadfight(QString p)
{
    QImage buff;
    buff.load(p);
    this->fight.push_back(buff);
